...
def user_log_sign_page(request):
    ...
    response = render(request, 'userlogsign.html')
    return HttpResponse(response)
...
def staff_log_sign_page(request):
    if request.method == 'POST':
        ...
        if user.is_staff:
            ...
            return redirect('staffloginpage')
    response = render(request, 'stafflogsign.html')
    return HttpResponse(response)
...
def edit_room(request):
    ...
    if request.method == 'POST' and request.user.is_staff:
        ...
        response = render(request, 'editroom.html', {'room': room})
        return HttpResponse(response)
...
def view_room(request):
    ...
    return HttpResponse(render(request, 'viewroom.html', {'room': room, 'reservations': reservation}))
...
def user_bookings(request):
    ...
    return HttpResponse(render(request, 'mybookings.html', {'bookings': bookings}))
